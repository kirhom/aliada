...
public class SearchController {
    ...
    public ResponseEntity<?> addNewSearch (Principal principal, @RequestBody Search search) {
    ...
    public ResponseEntity<?> getActiveSearches (Principal principal) {
        User user = this.validateUser(principal);
    ...
    public ResponseEntity<?> updateSearch (Principal principal, @PathVariable Long searchId, @RequestBody Search search) {
